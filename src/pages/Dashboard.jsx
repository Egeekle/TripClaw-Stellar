...
/**
 * ⚡ Bolt: Optimized Dashboard by removing simulation state.
 * High-frequency updates from the demo mode interval were moved to LiveFeed.jsx
 * to prevent unnecessary re-renders of the entire Dashboard component tree.
 */
