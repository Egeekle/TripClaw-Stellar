...
export default function Dashboard() {
  ...
  /**
   * PERFORMANCE: fetchCompletedMissionsCount is isolated to a specific effect
   * to avoid re-fetching on every dashboard render.
   */
  useEffect(() => {
  ...
  /**
   * PERFORMANCE: State Colocation - Moved high-frequency demoEvents state and interval
   * to <LiveFeed /> to prevent entire Dashboard from re-rendering every 3.5s.
   */
