...
export default function Dashboard() {
  ...
  // PERFORMANCE: Destructured only needed values. Removed unused wsStatus to reduce dependencies.
  ...
  // PERFORMANCE: High-frequency demo events state and interval were pushed down to LiveFeed component
  // to prevent re-rendering the entire Dashboard every 3.5 seconds.
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <LiveFeed events={agentEvents} isGatewayOnline={isGatewayOnline} />
          </div>
