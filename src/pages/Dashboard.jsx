      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            {/* Optimization: demoEvents state pushed down into LiveFeed to prevent Dashboard re-renders */}
            <LiveFeed realEvents={agentEvents} isGatewayOnline={isGatewayOnline} />
          </div>
