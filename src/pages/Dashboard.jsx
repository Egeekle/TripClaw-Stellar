...
export default function Dashboard() {
  ...
  /**
   * ⚡ Bolt Optimization:
   * Localized the demo event simulation to the <LiveFeed /> component.
   * This prevents the entire Dashboard and its high-intensity UI (Hero, Cards, Nav)
   * from re-rendering every 3.5 seconds during demo mode.
   */
