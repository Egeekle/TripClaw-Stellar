 ...
 * Prevents re-renders of the hero section when the parent Dashboard re-renders
 * due to other state changes that don't affect hero props.
 */
const AgentHero = React.memo(function AgentHero({ status, isGatewayOnline }) {
  return (
