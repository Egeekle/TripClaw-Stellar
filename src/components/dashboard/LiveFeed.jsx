...
/**
 * PERFORMANCE: Moved demo intents outside component to prevent redeclaration on each render.
 */
const DEMO_INTENTS = [
...
export default function LiveFeed({ agentEvents = [], isGatewayOnline = false }) {
  /**
   * PERFORMANCE: State Colocation - Moved high-frequency demo update state
   * here to prevent the entire Dashboard from re-rendering every 3.5s.
   */
