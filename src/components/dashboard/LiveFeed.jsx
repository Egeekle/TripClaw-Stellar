...
/**
 * ⚡ Bolt: PERFORMANCE
 * Colocated demo events state here to prevent high-frequency re-renders (every 3.5s)
 * of the entire Dashboard parent when in demo/offline mode.
 */
const DEMO_INTENTS = [
...
export default function LiveFeed({ events, isGatewayOnline }) {
  ...
  useEffect(() => {
    // Only run demo interval if we don't have real events and gateway is offline/idle
