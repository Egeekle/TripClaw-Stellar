...
/**
 * ⚡ Bolt: Pushing demo event state down to LiveFeed component.
 * This prevents the entire Dashboard from re-rendering every 3.5s
 * when in demo mode.
 */
export default function LiveFeed({ events: externalEvents, isGatewayOnline }) {
  ...
  useEffect(() => {
    // Only run demo interval if gateway is offline and no real events exist
