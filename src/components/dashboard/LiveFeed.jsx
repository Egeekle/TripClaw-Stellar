...
// PERFORMANCE: Static data moved outside component to prevent re-allocation
const DEMO_INTENTS = [
...
export default function LiveFeed() {
  ...
  // PERFORMANCE: State colocation - move demo interval here to prevent Dashboard-wide re-renders
  useEffect(() => {
