...
// PERFORMANCE: Move static data outside of component to avoid recreation on each render
const DEMO_INTENTS = [
...
// PERFORMANCE: Memoize component to shield it from unrelated Dashboard re-renders
const LiveFeed = React.memo(({ events, isGatewayOnline }) => {
  // PERFORMANCE: Colocated state for demo events to isolate re-renders to this component
